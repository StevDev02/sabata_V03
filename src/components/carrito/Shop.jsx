...
export function Shop() {
  ...
  return (
    <>
      ...
      <button
        className="w-[40px] bg-white rounded-full shadow-xl h-[40px] border right-3 bottom-3 translate-x-[-50%] translate-y-[-50%] fixed -m-2 p-2"
        type="button"
      >
        <a href="#filters">
          <svg
            ...
            className="icon icon-tabler icons-tabler-outline icon-tabler-filter-question"
          >
